...
```{r densitree, fig.cap = "densitree-style mapping of tree blocks/phylogenetic uncertainty [@bouckaertDensiTree2010]", cache=TRUE}
...
```
```{r lrtest-plot, fig.width = 7, fig.height = 10, fig.cap = "likelihood ratio test comparisons"}
plotmat(A, curve = 0,
