...
## did I mess up the order in the plot somehow when adding the 'nomiss' run?
all_ci |> filter(method %in% c("model_pcsc","mcmc_tb_nomiss","mcmc_tb"),
                 term == "gain.pc")
